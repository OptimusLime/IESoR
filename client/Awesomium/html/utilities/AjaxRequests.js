...
{
    if(!globalWebSocket)
        throw new Error("No websocket defined, can't make function calls!");
    //request 1 body
    globalWebSocket.callNativeFunction("getBodies", [1], function(jsonData)
    {
        console.log('Return getBodies single request');
...
function getBodies(numberBodies, bodyCallback, errorCallback)
{
    ...
    if(!globalWebSocket)
        throw new Error("No websocket defined, can't make function calls!");
    globalWebSocket.callNativeFunction("getBodies", [numberBodies], function(jsonData)
    {
        console.log('Return getBodies request');
...
function getGenomes(genomeIDArray, bodyCallback, errorCallback)
{
    ...
    if(!globalWebSocket)
        throw new Error("No websocket defined, can't make function calls!");
    globalWebSocket.callNativeFunction("getGenomes", [genomeIDArray], function(jsonData)
    {
        console.log('Return getGenomes request');
...
function getGenomeEvaluations(genomeIDArray, bodyCallback, errorCallback)
{
    ...
    globalWebSocket.callNativeFunction("zombieEvaluation", [genomeIDArray], function(jsonData)
    {
        console.log('Return zombieEvaluation request');
...
function getCurrentGeneration(bodyCallback, errorCallback)
{
    ...
    globalWebSocket.callNativeFunction("getCurrentGeneration", function(jsonData)
    {
        console.log('Return getCurrentGeneration request');
...
function getBestIndividuals(uid, bodyCallback, errorCallback)
{
    ...
    globalWebSocket.callNativeFunction("getBestBodies", [uid], function(jsonData)
    {
        console.log('Return getBestBodies request');
...
function runFullPCA(firstBehavior, xBin, yBin, selector, percent, bodyCallback, errorCallback)
{
    ...
    console.log('Sending FullPCA request');

    if(!globalWebSocket)
        throw new Error("No websocket defined, can't make function calls!");

    //request pca with a certain percentage
    globalWebSocket.callNativeFunction("runFullPCA", [firstBehavior, xBin, yBin, selector, percent], function(jsonData)
    {
        console.log('Return runFullPCA request');
...
{
    console.log('Sending EmptyPCA request');

    if(!globalWebSocket)
        throw new Error("No websocket defined, can't make function calls!");

    //request pca with a certain percentage
    globalWebSocket.callNativeFunction("runPCA", function(jsonData)
    {
        console.log('Return runPCA request');
...
function getLatestArchive(bodyCallback, errorCallback)
{
    ...
    //request pca with a certain percentage
    globalWebSocket.callNativeFunction("getArchive", function(jsonData)
    {
        console.log('Return getArchive request');
...
function toggleSelectedBody(genomeID, successCallback, errorCallback)
{
    ...
    //request pca with a certain percentage
    globalWebSocket.callNativeFunction("toggle", function(jsonData)
    {
        console.log('Return toggle request');
